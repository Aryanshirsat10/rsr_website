...
const sponsorspage = () => {
  return (
    <>
      <Navbar />
      <div className="mt-20 flex flex-row flex-wrap gap-10 h-full items-center justify-center content-center scroll-smooth">
