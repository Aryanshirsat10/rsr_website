      ...
      <div className="mt-16 pt-10 flex flex-col flex-wrap gap-10 h-full items-center justify-center bg-black p-5">
        ...
        <div className="flex flex-row flex-wrap items-center justify-center gap-10 xl:gap-20">
          <div className="flex items-center justify-center">
            <div className="w-[400px] h-[450px] bg-gradient-to-r from-slate-700 from-opacity-60 to-slate-900 relative shadow-2xl shadow-slate-800 cursor-pointer transition-all duration-[0.3s] rounded-[20px] lg:hover:scale-[1.05]">
