...
const Fund = () => {
  return (
    <>
      <div className="mt-16 pt-10 flex flex-col flex-wrap gap-10 h-full items-center justify-center bg-black p-5">
        <div>
          <h2 className="text-3xl font-bold text-white">Benefits To Get</h2>
        </div>
        <div className="flex flex-col items-center gap-5">
          <h2 className="text-3xl font-bold text-white">Budget Roadmap</h2>
        ...
        <div className="flex flex-row flex-wrap items-center justify-center gap-10 xl:gap-20">
          <div className="flex items-center justify-center">
            <div className="w-[280px] md:w-[400px] h-[450px] bg-gradient-to-r from-slate-700 from-opacity-60 to-slate-900 relative shadow-2xl shadow-slate-800 cursor-pointer transition-all duration-[0.3s] rounded-[20px] lg:hover:scale-[1.05]">
              ...
              <div className="absolute flex flex-col p-10 top-16 justify-center text-white">
                <p>-Frame & Certificate</p>
                <p>-Special mention on our all social media handles & videos</p>
                <p>-LOGO on standees, flex, t-shirt, vehicle, etc.</p>
                <p>-Oportunity to drive the prototype</p>
                <p>-Involves national & international exposure</p>
                <p>
                  -Brand endorsement through orientaion, exhibitions &
                  competitions.
                </p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-center">
            <div className="w-[280px] md:w-[400px] h-[450px] bg-gradient-to-r from-slate-700 from-opacity-60 to-slate-900 relative shadow-2xl shadow-slate-800 cursor-pointer transition-all duration-[0.3s] rounded-[20px] lg:hover:scale-[1.05]">
              ...
              <div className="absolute flex flex-col p-10 top-16 justify-center text-white">
                <p>-Frame & Certificate</p>
                <p>-Special mention on our website</p>
                <p>-LOGO on standees & t-shirt</p>
              </div>
            </div>
          </div>
        </div>
