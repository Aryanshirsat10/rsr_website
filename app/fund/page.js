...
const Fund = () => {
  return (
    <>
        <Navbar/>
        <div className='mt-32 flex flex-col flex-wrap gap-10 h-full items-center justify-center'>
        <div>
        ...
        <div className='flex flex-col items-center gap-5'>
            ...
            <div className='w-[70%] h-[70%] shadow-2xl shadow-slate-700 mb-20 rounded-lg'>
                <img src='/images/Budget_Roadmap.png' alt='Budget Roadmap' className='rounded-lg'/>
            </div>
        </div>
