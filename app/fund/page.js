          ...
          <div className="flex items-center justify-center">
            <div className="w-[400px] h-[450px] bg-gradient-to-r from-slate-700 from-opacity-60 to-slate-900 relative shadow-2xl shadow-slate-800 cursor-pointer transition-all duration-[0.3s] rounded-[20px] lg:hover:scale-90">
              ...
              <div className="absolute flex flex-col p-10 top-16 justify-center ">
                  ...
                  <p>-Brand endorsement through orientaion, exhibitions & competitions.</p>
              </div>
            </div>
          </div>
          <div className="flex items-center justify-center">
