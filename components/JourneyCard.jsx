...
const JourneyCard = ({ index, title, para, link, year }) => {
  ...
  return (
    <div className="flex  flex-row min-h-min z-1 gap-4 justify-items-center lg:even:flex-row-reverse">
      ...
      <div
        id={`heading${index}`}
        className="flex flex-start flex-col h-min content-center pb-32 max-w-[385px] opacity-0"
      >
        ...
        <div className="flex flex-col flex-start text-base text-justify ">
          ...
          <span className="mb-2 absolute bottom-20 left-2 text-4xl md:text-7xl font-semibold drop-shadow-lg text-white">
            {year}
          </span>
